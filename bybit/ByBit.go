...
func (bn *ByBit) buildParamsSigned(postForm *url.Values) error {
...
func (bn *ByBit) GetExchangeName() string {
	return "ByBit"
}

func (bn *ByBit) Ping() bool {
...
func (bn *ByBit) setTimeOffset() error {
...
func (bn *ByBit) GetTicker(currency CurrencyPair) (*Ticker, error) {
...
func (bn *ByBit) GetDepth(size int, currencyPair CurrencyPair) (*Depth, error) {
	if size <= 5 {
		size = 5
	} else if size <= 10 {
		size = 10
...
func (bn *ByBit) placeOrder(amount, price string, pair CurrencyPair, orderType, orderSide string) (*Order, error) {
...
func (bn *ByBit) GetAccount() (*Account, error) {
	params := url.Values{}
	bn.buildParamsSigned(&params)
...
func (bn *ByBit) LimitBuy(amount, price string, currencyPair CurrencyPair, opt ...LimitOrderOptionalParameter) (*Order, error) {
	return bn.placeOrder(amount, price, currencyPair, "LIMIT", "BUY")
}

func (bn *ByBit) LimitSell(amount, price string, currencyPair CurrencyPair, opt ...LimitOrderOptionalParameter) (*Order, error) {
	return bn.placeOrder(amount, price, currencyPair, "LIMIT", "SELL")
}

func (bn *ByBit) MarketBuy(amount, price string, currencyPair CurrencyPair) (*Order, error) {
	return bn.placeOrder(amount, price, currencyPair, "MARKET", "BUY")
}

func (bn *ByBit) MarketSell(amount, price string, currencyPair CurrencyPair) (*Order, error) {
	return bn.placeOrder(amount, price, currencyPair, "MARKET", "SELL")
}

func (bn *ByBit) CancelOrder(orderId string, currencyPair CurrencyPair) (bool, error) {
	path := bn.apiV3 + ORDER_URI
	params := url.Values{}
...
func (bn *ByBit) GetOneOrder(orderId string, currencyPair CurrencyPair) (*Order, error) {
	params := url.Values{}
	params.Set("symbol", currencyPair.ToSymbol(""))
	if orderId != "" {
		params.Set("orderId", orderId)
...
func (bn *ByBit) GetUnfinishOrders(currencyPair CurrencyPair) ([]Order, error) {
	params := url.Values{}
	params.Set("symbol", currencyPair.ToSymbol(""))
...
func (bn *ByBit) GetKlineRecords(currency CurrencyPair, period KlinePeriod, size int, optional ...OptionalParameter) ([]Kline, error) {
	params := url.Values{}
...
//非个人，整个交易所的交易记录
//注意：since is fromId
func (bn *ByBit) GetTrades(currencyPair CurrencyPair, since int64) ([]Trade, error) {
	param := url.Values{}
...
func (bn *ByBit) GetOrderHistorys(currency CurrencyPair, optional ...OptionalParameter) ([]Order, error) {
	params := url.Values{}
...
func (bn *ByBit) toCurrencyPair(symbol string) CurrencyPair {
...
func (bn *ByBit) GetExchangeInfo() (*ExchangeInfo, error) {
...
func (bn *ByBit) GetTradeSymbol(currencyPair CurrencyPair) (*TradeSymbol, error) {
	if bn.ExchangeInfo == nil {
		var err error
		bn.ExchangeInfo, err = bn.GetExchangeInfo()
		if err != nil {
...
func (bn *ByBit) adaptError(err error) error {
	errStr := err.Error()
...
func (bn *ByBit) adaptOrder(currencyPair CurrencyPair, orderMap map[string]interface{}) Order {
