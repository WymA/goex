...
type ByBitSwap struct {
	ByBit
	f *ByBitFutures
}

func NewByBitSwap(config *APIConfig) *ByBitSwap {
	if config.Endpoint == "" {
...
func (bs *ByBitSwap) SetBaseUri(uri string) {
	bs.baseUrl = uri
}

func (bs *ByBitSwap) GetExchangeName() string {
	return BINANCE_SWAP
}

func (bs *ByBitSwap) Ping() bool {
...
func (bs *ByBitSwap) setTimeOffset() error {
...
func (bs *ByBitSwap) GetFutureEstimatedPrice(currencyPair CurrencyPair) (float64, error) {
	panic("not supported.")
}

func (bs *ByBitSwap) GetFutureTicker(currency CurrencyPair, contractType string) (*Ticker, error) {
...
func (bs *ByBitSwap) GetFutureDepth(currency CurrencyPair, contractType string, size int) (*Depth, error) {
	if contractType == SWAP_CONTRACT {
...
func (bs *ByBitSwap) GetFutureOrderHistory(pair CurrencyPair, contractType string, optional ...OptionalParameter) ([]FutureOrder, error) {
	panic("implement me")
}

func (bs *ByBitSwap) GetTrades(contractType string, currencyPair CurrencyPair, since int64) ([]Trade, error) {
	if contractType == SWAP_CONTRACT {
...
func (bs *ByBitSwap) GetFutureIndex(currencyPair CurrencyPair) (float64, error) {
...
func (bs *ByBitSwap) GetFutureUserinfo(currencyPair ...CurrencyPair) (*FutureAccount, error) {
...
func (bs *ByBitSwap) Transfer(currency Currency, transferType int, amount float64) (int64, error) {
	params := url.Values{}
...
func (bs *ByBitSwap) PlaceFutureOrder(currencyPair CurrencyPair, contractType, price, amount string, openType, matchPrice int, leverRate float64) (string, error) {
...
func (bs *ByBitSwap) PlaceFutureOrder2(currencyPair CurrencyPair, contractType, price, amount string, openType, matchPrice int, leverRate float64) (*FutureOrder, error) {
	if contractType == SWAP_CONTRACT {
...
func (bs *ByBitSwap) LimitFuturesOrder(currencyPair CurrencyPair, contractType, price, amount string, openType int, opt ...LimitOrderOptionalParameter) (*FutureOrder, error) {
	return bs.PlaceFutureOrder2(currencyPair, contractType, price, amount, openType, 0, 10)
}

func (bs *ByBitSwap) MarketFuturesOrder(currencyPair CurrencyPair, contractType, amount string, openType int) (*FutureOrder, error) {
	return bs.PlaceFutureOrder2(currencyPair, contractType, "0", amount, openType, 1, 10)
}

func (bs *ByBitSwap) FutureCancelOrder(currencyPair CurrencyPair, contractType, orderId string) (bool, error) {
	if contractType == SWAP_CONTRACT {
...
func (bs *ByBitSwap) FutureCancelAllOrders(currencyPair CurrencyPair, contractType string) (bool, error) {
	if contractType == SWAP_CONTRACT {
...
func (bs *ByBitSwap) FutureCancelOrders(currencyPair CurrencyPair, contractType string, orderIdList []string) (bool, error) {
	if contractType != SWAP_USDT_CONTRACT {
		return false, errors.New("contract is error,please incoming SWAP_CONTRACT or SWAP_USDT_CONTRACT")
	}
...
func (bs *ByBitSwap) GetFuturePosition(currencyPair CurrencyPair, contractType string) ([]FuturePosition, error) {
	if contractType == SWAP_CONTRACT {
...
func (bs *ByBitSwap) GetFutureOrders(orderIds []string, currencyPair CurrencyPair, contractType string) ([]FutureOrder, error) {
	if contractType == SWAP_CONTRACT {
...
func (bs *ByBitSwap) GetFutureOrder(orderId string, currencyPair CurrencyPair, contractType string) (*FutureOrder, error) {
	if contractType == SWAP_CONTRACT {
...
func (bs *ByBitSwap) parseOrder(rsp map[string]interface{}) *FutureOrder {
	order := &FutureOrder{}
...
func (bs *ByBitSwap) parseOrderStatus(sts string) TradeStatus {
...
func (bs *ByBitSwap) GetUnfinishFutureOrders(currencyPair CurrencyPair, contractType string) ([]FutureOrder, error) {
	if contractType == SWAP_CONTRACT {
...
func (bs *ByBitSwap) GetFee() (float64, error) {
	panic("not supported.")
}

func (bs *ByBitSwap) GetContractValue(currencyPair CurrencyPair) (float64, error) {
	panic("not supported.")
}

func (bs *ByBitSwap) GetDeliveryTime() (int, int, int, int) {
	panic("not supported.")
}

func (bs *ByBitSwap) GetKlineRecords(contractType string, currency CurrencyPair, period KlinePeriod, size int, opt ...OptionalParameter) ([]FutureKline, error) {
	if contractType == SWAP_CONTRACT {
...
func (bs *ByBitSwap) SetLeverRate(currencyPair CurrencyPair, contractType string, leverage int) (string, error) {
...
func (bs *ByBitSwap) GetServerTime() (int64, error) {
	respmap, err := HttpGet(bs.httpClient, bs.apiV1+SERVER_TIME_URL)
	if err != nil {
		return 0, err
	}
...
func (bs *ByBitSwap) adaptCurrencyPair(pair CurrencyPair) CurrencyPair {
