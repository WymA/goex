...
func NewByBitFutures(config *APIConfig) *ByBitFutures {
	if config.Endpoint == "" {
...
func (bs *ByBitFutures) SetBaseUri(uri string) {
	bs.base.baseUrl = uri
}

func (bs *ByBitFutures) GetExchangeName() string {
	return BINANCE_FUTURES
}

func (bs *ByBitFutures) GetFutureTicker(currencyPair CurrencyPair, contractType string) (*Ticker, error) {
...
func (bs *ByBitFutures) GetFutureDepth(currencyPair CurrencyPair, contractType string, size int) (*Depth, error) {
	symbol, err := bs.adaptToSymbol(currencyPair, contractType)
	if err != nil {
		return nil, err
	}
...
func (bs *ByBitFutures) GetFutureIndex(currencyPair CurrencyPair) (float64, error) {
	panic("not supported.")
}

func (bs *ByBitFutures) GetFutureUserinfo(currencyPair ...CurrencyPair) (*FutureAccount, error) {
...
func (bs *ByBitFutures) PlaceFutureOrder(currencyPair CurrencyPair, contractType, price, amount string, openType, matchPrice int, leverRate float64) (string, error) {
	apiPath := "order"
	symbol, err := bs.adaptToSymbol(currencyPair, contractType)
	if err != nil {
		return "", err
...
func (bs *ByBitFutures) LimitFuturesOrder(currencyPair CurrencyPair, contractType, price, amount string, openType int, opt ...LimitOrderOptionalParameter) (*FutureOrder, error) {
...
func (bs *ByBitFutures) MarketFuturesOrder(currencyPair CurrencyPair, contractType, amount string, openType int) (*FutureOrder, error) {
...
func (bs *ByBitFutures) FutureCancelOrder(currencyPair CurrencyPair, contractType, orderId string) (bool, error) {
	apiPath := "order"
	symbol, err := bs.adaptToSymbol(currencyPair, contractType)
	if err != nil {
		return false, err
...
func (bs *ByBitFutures) GetFuturePosition(currencyPair CurrencyPair, contractType string) ([]FuturePosition, error) {
	symbol, err := bs.adaptToSymbol(currencyPair, contractType)
	if err != nil {
		return nil, err
	}
...
func (bs *ByBitFutures) GetFutureOrders(orderIds []string, currencyPair CurrencyPair, contractType string) ([]FutureOrder, error) {
	panic("not supported.")
}

func (bs *ByBitFutures) GetFutureOrder(orderId string, currencyPair CurrencyPair, contractType string) (*FutureOrder, error) {
	apiPath := "order"
	symbol, err := bs.adaptToSymbol(currencyPair, contractType)
	if err != nil {
		return nil, err
...
func (bs *ByBitFutures) GetUnfinishFutureOrders(currencyPair CurrencyPair, contractType string) ([]FutureOrder, error) {
	apiPath := "openOrders"
	param := url.Values{}
...
func (bs *ByBitFutures) GetFutureOrderHistory(pair CurrencyPair, contractType string, optional ...OptionalParameter) ([]FutureOrder, error) {
	panic("implement me")
}

func (bs *ByBitFutures) GetFee() (float64, error) {
	panic("not supported.")
}

func (bs *ByBitFutures) GetContractValue(currencyPair CurrencyPair) (float64, error) {
	switch currencyPair {
	case BTC_USD:
		return 100, nil
	default:
...
func (bs *ByBitFutures) GetDeliveryTime() (int, int, int, int) {
	panic("not supported.")
}

func (bs *ByBitFutures) GetKlineRecords(contractType string, currency CurrencyPair, period KlinePeriod, size int, opt ...OptionalParameter) ([]FutureKline, error) {
	panic("not supported.")
}

func (bs *ByBitFutures) GetTrades(contractType string, currencyPair CurrencyPair, since int64) ([]Trade, error) {
	panic("not supported.")
}

func (bs *ByBitFutures) GetFutureEstimatedPrice(currencyPair CurrencyPair) (float64, error) {
	panic("not supported.")
}

func (bs *ByBitFutures) GetExchangeInfo() {
...
func (bs *ByBitFutures) SetLeverRate(currencyPair CurrencyPair, contractType string, leverage int) (string, error) {
...
func (bs *ByBitFutures) adaptToSymbol(pair CurrencyPair, contractType string) (string, error) {
...
func (bs *ByBitFutures) adaptStatus(status string) TradeStatus {
	switch status {
	case "NEW":
...
func (bs *ByBitFutures) adaptOType(side string, positionSide string) int {
